...
for SEL_CEL in drug_names:
    ...
    Feat_DF = pd.read_csv(
        "GDSC2_filtered_featrue_var1.csv")  # Load the drug descriptors of the drugs applied on the selected cell line
    ...
    with open('MDS_mapping_GDSC2_1.pickle', 'rb') as file:
