...
for (j in 1:ncol(GDSC2_response)) {
  ...
  cor(c(1:length(sort(filter_outliers(GDSC2_response_j)))),sort(filter_outliers(GDSC2_response_j)))
  if(cor(c(1:length(sort(filter_outliers(GDSC2_response_j)))),sort(filter_outliers(GDSC2_response_j)))<=0.95){
    ...
    GDSC2_response_class[which(GDSC2_response[,j] > median_j),j] <- 0

    if(length(which(GDSC2_response[,j] > median_j))<length(GDSC2_response_j)*0.1){
      GDSC2_response_class[order(x=GDSC2_response_j,decreasing=TRUE)[1:length(GDSC2_response_j)*0.1],j] <- 0
    }
    if(length(which(GDSC2_response[,j] <= median_j))<length(GDSC2_response_j)*0.1){
      GDSC2_response_class[order(x=GDSC2_response_j,decreasing=FALSE)[1:length(GDSC2_response_j)*0.1],j] <- 1
    }
...
write.csv(GDSC2_response,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/GDSC1_response_revision2.csv")
write.csv(GDSC2_response_class,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/GDSC1_response_class_waterfall_revision2.csv")
...
for (j in 1:ncol(CTRP_response)) {
  ...
  if(cor(c(1:length(sort(filter_outliers(CTRP_response_j)))),sort(filter_outliers(CTRP_response_j)))<=0.95){
    ...
    CTRP_response_class[which(CTRP_response[,j] > median_j),j] <- 0
    if(length(which(CTRP_response[,j] > median_j))<length(CTRP_response_j)*0.1){
      CTRP_response_class[order(x=CTRP_response_j,decreasing=TRUE)[1:length(CTRP_response_j)*0.1],j] <- 0
    }
    if(length(which(CTRP_response[,j] <= median_j))<length(CTRP_response_j)*0.1){
      CTRP_response_class[order(x=CTRP_response_j,decreasing=FALSE)[1:length(CTRP_response_j)*0.1],j] <- 1
    }
...
write.csv(CTRP_response,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/CTRP_response_revision2.csv")
write.csv(CTRP_response_class,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/CTRP_response_class_waterfall_revision2.csv")
...
CTRP_response_class_common <- subset(CTRP_response_class, select = c('AZD7762', 'PLX-4720', 'olaparib', 'docetaxel:tanespimycin (2:1 mol/mol)','linsitinib','fluorouracil'))
colnames(CTRP_response_class_common) <- c('AZD7762', 'PLX4720', 'Olaparib', 'Docetaxel', 'Linsitinib','Fluorouracil')
...
GDSC2_response_class_common <- subset(GDSC2_response_class, select = c('AZD7762_1022', 'PLX-4720_1036', 'Olaparib_1017', 'Docetaxel_1007', 'Linsitinib_1510', '5-Fluorouracil_1073'))
colnames(GDSC2_response_class_common) <- c('AZD7762', 'PLX4720', 'Olaparib','Dasatinib', 'Docetaxel', 'Linsitinib','Fluorouracil')


write.csv(CTRP_response_class_common,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/CTRP_response_class_common_waterfall_revision2.csv")
write.csv(GDSC2_response_class_common,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/GDSC2_response_class_common_waterfall_revision2.csv")
...
write.csv(CTRP_Expr_feature_common,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/CTRP_Expr_feature_common_revision2.csv")
write.csv(GDSC2_Expr_feature_common,"/Users/xulu/Desktop/work/学术资源/论文撰写/FedDRP/NIID-Bench-main/data/commonWaterfall/GDSC2_Expr_feature_common_revision2.csv")
